...
| [architecture.md](architecture.md) | Module par module du SDK `xui/` : `__init__`, `context`, `mount`, `nav`, `packages`, `csrf`, `forms` ; flux d'une requête ; câblage de `main.py` ; divergences spec/code ; état du MFE. |
